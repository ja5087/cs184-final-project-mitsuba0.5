...
CXXFLAGS       = ['-fPIC', '-O3', '-Wall', '-g', '-pipe', '-march=nocona', '-msse2', '-ftree-vectorize', '-mfpmath=sse', '-funsafe-math-optimizations', '-fno-rounding-math', '-fno-signaling-nans', '-fno-math-errno', '-fomit-frame-pointer', '-DMTS_DEBUG', '-DSINGLE_PRECISION', '-DSPECTRUM_SAMPLES=3', '-DMTS_SSE', '-DMTS_HAS_COHERENT_RT', '-fopenmp', '-fvisibility=hidden', '-mtls-dialect=gnu2', '-L/usr/lib/x86_64-linux-gnu', '-lQt5Concurrent', '-lQt5Core', '-lQt5DBus', '-lQt5EglFSDeviceIntegration', '-lQt5EglFsKmsSupport', '-lQt5Gui', '-lQt5Network', '-lQt5OpenGLExtensions', '-lQt5OpenGL', '-lQt5PrintSupport', '-lQt5Sql', '-lQt5Test', '-lQt5Widgets', '-lQt5XcbQpa', '-lQt5XmlPatterns', '-lQt5Xml'] 
LINKFLAGS      = []
SHLINKFLAGS    = ['-L/usr/lib/x86_64-linux-gnu', '-lQt5Concurrent', '-lQt5Core', '-lQt5DBus', '-lQt5EglFSDeviceIntegration', '-lQt5EglFsKmsSupport', '-lQt5Gui', '-lQt5Network', '-lQt5OpenGLExtensions', '-lQt5OpenGL', '-lQt5PrintSupport', '-lQt5Sql', '-lQt5Test', '-lQt5Widgets', '-lQt5XcbQpa', '-lQt5XmlPatterns', '-lQt5Xml', '-rdynamic', '-shared', '-fPIC', '-lstdc++']
